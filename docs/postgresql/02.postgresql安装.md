...
apt-get install bison flex libsystemd-dev   libxml2-utils
...
pg_hba.conf的路径由/etc/postgresql/13/main/postgresql.conf中的hba_file = '/etc/postgresql/13/main/pg_hba.conf'来控制
