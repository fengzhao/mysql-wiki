...
2010年04月22日，Oracle发布了MySQL 5.5。

**自此，MySQL 进入了发展的快车道，成为了最流行的数据库（MySQL, the most popular Open Source SQL database management system, is developed, distributed, and supported by Oracle Corporation.）**
