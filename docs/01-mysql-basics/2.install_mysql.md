...
# 最新版
https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-8.4.8-linux-glibc2.28-x86_64.tar.xz
```
...
# wget https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-8.4.8-linux-glibc2.17-x86_64.tar.xz
...
``` shell
$ tar -xvf  /tmp/mysql-8.4.8-linux-glibc2.28-x86_64.tar.xz -C /usr/local
$ mv /usr/local/mysql-8.4.8-linux-glibc2.28-x86_64  /usr/local/mysql
$ cd  /usr/local/mysql
